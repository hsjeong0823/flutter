...
class _SeccondApp extends State<SecondApp> {
              ...
              children: [
                ...
                Container(
                  ...
                  child: ListView(
                    ...
                    children: [
                      GestureDetector(
                        child: Image.asset('repo/images/cow.png', width: 100),
                        onTap: () {
                          _imagePath = 'repo/images/cow.png';
                        },
                      ),
                      GestureDetector(
                        child: Image.asset('repo/images/pig.png', width: 100),
                        onTap: () {
                          _imagePath = 'repo/images/pig.png';
                        },
                      ),
                      GestureDetector(
                        child: Image.asset('repo/images/bee.png', width: 100),
                        onTap: () {
                          _imagePath = 'repo/images/bee.png';
                        },
                      ),
                      GestureDetector(
                        child: Image.asset('repo/images/cat.png', width: 100),
                        onTap: () {
                          _imagePath = 'repo/images/cat.png';
                        },
                      ),
                      GestureDetector(
                        child: Image.asset('repo/images/dog.png', width: 100),
                        onTap: () {
